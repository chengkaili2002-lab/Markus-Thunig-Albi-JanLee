...
from schemas import Task2Result
from utils import build_task2_summary_row, run_task_batch


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Task 2 lane semantics analysis")
    parser.add_argument(
        "--model",
    ...
    if args.output_dir is None:
        ...
        output_dir = RESULTS_DIR / "task2" / "runs" / timestamp
    else:
